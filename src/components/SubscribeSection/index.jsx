        ...
        <div className="lg:grid grid-cols-2 text-center lg:text-left bg-test w-full rounded-[75px]">
          ...
          <div className="lg:w-full lg:h-[253px] flex items-center justify-between relative w-full lg:mt-5 md:mt-0">
            ...
            <form className="w-full">
              <div className="relative w-full mt-10 bg-white shadow-xl border border-blue_gray-50 border-solid lg:flex lg:flex-row h-max inset-y-[0] items-center justify-between left-[0] lg:my-auto p-2 rounded-[34px] shadow-[10px 20px  50px 0px #00000026] w-full md:w-[84%]">
                <input
