    ...
    <div className="flex flex-col lg:flex-row lg:w-full">
      <div className="container w-full p-5 mx-auto lg:w-1/3 lg:text-left text-center lg:mr-8 left-0 z-10">
        <div className="lg:mt-hero-section-margin-top lg:ml-12">
          ...
          <p className="mt-6 lg:mt-10 text-gray-700 text-xl max-w-m mx-auto lg:mx-0">
      ...
      <div className="lg:w-7/12 lg:ml-8 lg:mr-0 mt-hero-image-margin-top mx-auto right-0">
