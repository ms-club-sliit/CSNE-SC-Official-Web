...
const HeroSection = () => {
  return (
    <div className="relative flex flex-col lg:flex-row">
      <div className="lg:text-left text-center mx-auto w-hero-section-text-width h-hero-section-text-height lg:ml-hero-section-margin-left lg:mt-hero-section-margin-top">
      ...
      <div className="lg:flex-1 lg:ml-8 lg:mr-0 mt-hero-image-margin-top mx-auto relative">
        ...
        <div>
          <img
            ...
            className="mx-0 lg:mr-0 w-full lg:h-hero-section-image-height h-auto overflow-hidden rounded-tl-0 rounded-tr-0 rounded-br-0 rounded-bl-hero-section-image"
          />
        </div>
