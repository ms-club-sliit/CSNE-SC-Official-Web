            ...
            {slides.map((slide) => (
                <SwiperSlide key={slide.id}>
                    <div className={"grid grid-cols-3 gap-2"}>
                        <div
                            className={"col-span-2 w-full h-64 bg-gray-300 bg-cover bg-center bg-no-repeat rounded-2xl shadow-lg"}
                        ...
                        <div
                            className={"col-span-1 w-full h-64 bg-center bg-no-repeat flex flex-col justify-center pl-4"}
                            style={{backgroundImage: "url('/images/past-events-bg.svg')"}}
                        >
                            <h1 className={"text-md lg:text-lg xl:text-4xl"}>{slide.title}</h1>
                            <p className={"text-xs lg:text-md xl:text-lg"}>{slide.description}</p>
                        </div>
                    </div>
                </SwiperSlide>
            ))}
