      ...
      <div className=" container h-full w-full bg-white  items-center justify-center p-2 sm:p-0 lg:w-full md:justify-center md:items-center lg:justify-center lg:items-center xl:w-full 2xl:w-full">
        <div className="flex flex-col items-center justify-center  w-full sm:w-full  ">
          <div className="flex w-full flex-col items-center space-y-4 sm: md:w-full lg:w-full ">
            <div className="h-[90vh] flex flex-col-reverse  items-center justify-center w-full  sm:flex-col-reverse sm:justify-center  sm:items-center lg:flex-row lg:justify-around lg:w-[100vh] lg:h-[85vh]  xl:h-[80vh] xl:w-[120vh] 2xl:w-[85vh] 2xl:h-[40vh] 2xl:mt-[8vh] ">
              <div className="w-full sm:w-3/3 lg:w-full p-4  sm:text-center sm:flex lg:flex  xl:w-3/4 lg:mb-[5vh] xl:mb-[5vh]">
                <div className="text-wrap ... sm:flex sm:items-center sm:justify-center lg:flex ">
                  <div className="lg:w-3/4 ">
                    <h1 className="text-4xl sm:text-4xl m-4 sm:m-8 lg:text-6xl text-black font-bold text-center sm:mr-4 xl:6xl ">
                      Our way of success
                    </h1>
                    <p className="text-base sm:text-xl text-black leading-relaxed text-justify sm:ml-4 md:text-center lg:text-center lg:text-xl xl:5xl">
              ...
              <Image
                ...
                height={600}
                alt="success stories"
                className="w-3/4 border-2 rounded-2xl border-gray-300 shadow-lg  sm:mx-8 sm:mt-12 sm:ml-15  sm:w-3/5 lg:w-4/5 lg:mb-[20vh]  xl:w-4/5 "
              />
            </div>
            ...
            >
              <div className="flex flex-col md:w-full  lg:w-[100vh]  xl:w-[120vh] 2xl:w-[85vh] ">
