        ...
        <div className="container mx-auto flex flex-row lg:grid lg:grid-cols-3 gap-5 flex-wrap h-auto justify-center">
          ...
          <div className="flex text-center lg:text-left flex-col p-10 h-fit bg-white rounded-xl lg:mr-10">
            ...
            <div className="mx-auto">
              ...
              <div className="flex flex-row mt-4 sm:mt-6 space-x-3">
                <Image
          ...
          <form className="flex flex-col p-10 col-span-2 w-full text-center lg:text-left lg:bg-white rounded-xl">
            ...
            <input
              type="text"
              name="name"
              className=" border-2 px-5 border-lightgray rounded-3xl w-80vw h-12 mt-3 mr-0 lg:mr-5"
              required
            />
            <div className="flex flex-row mt-4 space-x-4 mx-auto lg:mx-0">
            ...
            {existing && (
              <div>
                ...
                <select
                  name="year"
                  className="border-2 px-5 border-lightgray rounded-3xl w-full h-12 mt-3 mr-0 lg:mr-5 lg:w-[720px]"
                  required
                >
            ...
            <textarea
              name="message"
              className="border-2 p-5 text-wrap border-lightgray rounded-3xl w-80vw h-60 mt-3 mr-0 lg:mr-5"
              required
            />
            <div className="relative flex w-full justify-center lg:justify-end">
              <button
                type="submit"
                className="bg-hero-section-button text-white lg:text-lg py-3 rounded-full mt-8 w-max px-10 "
              >
                Send
              </button>
            </div>
